  ...
  const NAGRADNA_IGRA_SECTIONS = [
    {
      ...
      text: (
        <>
          <h3
            className="font-clashDisplay text-[40px] font-normal leading-[49.2px] tracking-[0.01em] text-left text-white mb-6"
            style={{
...
Obavezno zapratite naše zvanične Instagram i Facebook profile, kako biste bili blagovremeno informisani o svim novostima.`,
   </>) },
    {
      ...
      text: "Privee ima tri osnovne cjeline i na svaku od njih prelazite povlačenjem (swiping) lijevo ili desno.",
    },
    {

      text: (<>U nastavku, u video materijalu pogledajte kako uploadovati i kreirati svoj film #RECAP24.<br></br> <br></br>
      Napomena: Svaki upload završava u vašem privatnom profilu. Kako biste svoj film objavili da bude vidljiv svima, potrebno je svaki video/foto/scenu pojedinačno objaviti.
Na dnu ekrana možete pronaći ikonicu (krug) koji sadrži vodič za korištenje aplikacije. Za više informacija posjetite www.privee.world <br></br> <br></br>
<div style={{ textAlign: "center" }}>
            <button
              onClick={() => window.open("https://priveee.onelink.me/AMM3/1313DJ", "_blank")}
              style={{
    ...
    },
    {
      ...
      text: "Prva nagrada: Potpuno novi iPhone 16 – zabilježi svoje buduće trenutke u vrhunskoj kvaliteti. Druga nagrada: Apple AirPods – uživaj u omiljenoj muzici uz savršeni zvuk. Neograničen broj objava za osam korsnika Privee World platforme.",
    },
    {
      heading: "Važne informacije",
      text: (<>Trajanje nagradne igre:
...
Inspiracija je ključ: Dijeli trenutke koji će pokrenuti emocije kod publike.
    ...
    },
    {
      ...
      text: (<>Ovo je tvoja prilika da podijeliš svoje uspomene iz 2024. godine i osvojiš fantastične nagrade! Bilo da se radi o nevjerovatnom putovanju, posebnom životnom trenutku, ili zabavnoj situaciji koja te nasmijala do suza – tvoje priče vrijede pažnje! <br></br> <br></br> <br></br></>),
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row relative h-screen w-full max-w-[1600px] overflow-y-auto px-4 py-12 sm:px-8 sm:py-16">
        {/* Content Section */}
              ...
              {NAGRADNA_IGRA_SECTIONS.map((section, idx) => (
                ...
                >
                  <div className="w-full lg:w-[85%] xl:w-[95%] mx-auto px-4">
                    <h2
                      className="font-clashDisplay text-[40px] font-semibold leading-[49.2px] tracking-[0.01em] text-left text-white mb-0.2"
                      style={{
                        textUnderlinePosition: "from-font",
                        textDecorationSkipInk: "none",
                      }}
