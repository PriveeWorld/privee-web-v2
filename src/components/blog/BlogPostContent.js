...
export default function BlogPostContent({ post }) {
  ...
  const shareButtons = [
    ...
    },
    {
      ...
      link: `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(shareUrl)}&title=${encodeURIComponent(shareText)}`,
    },
    {
      platform: 'Copy Link',
      icon: (
          ...
          <div className="w-full max-w-[1200px] mx-auto px-4 py-4 sm:px-8">
            ...
            >
              ...
              <div className="mb-6 flex items-center justify-between border-b border-gray-200 pb-4">
                ...
                <div className="flex items-center">
                  <span className="mr-3 text-sm text-gray-600">Share this blog:</span>
                  ...
                  {copied && (
                    <span className="text-sm text-[#CD1A70] ml-2">Link copied!</span>
                  )}
                </div>
              </div>
